module github.com/illmade-knight/go-notification-service
...
require (
	...
	github.com/illmade-knight/go-secure-messaging v0.0.15
...
require (
	...
	github.com/illmade-knight/go-action-intention-protos v1.0.34 // indirect
